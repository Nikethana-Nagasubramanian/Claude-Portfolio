...
(function () {
  ...
  function build() {
    ...
    rail.innerHTML = [
      ...
      '<a class="ai-button ai-button--claude" href="https://claude.ai/new?q=' + AI_PROMPT + '" target="_blank" rel="noopener"><img class=\"ai-icon\" src=\"assets/icons/claude-star.png\" alt=\"\" aria-hidden=\"true\" width=\"16\" height=\"16\" />Ask about Nike</a>',
      "</div>",
